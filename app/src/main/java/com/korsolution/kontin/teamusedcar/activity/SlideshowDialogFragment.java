...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mImages = getArguments().getStringArray("mImages");
    ...
    private void displayMetaInfo(int position) {
        ...
        lblCount.setText((position + 1) + " of " + mImages.length);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            ZoomageView myZoomageView = (ZoomageView) view.findViewById(R.id.myZoomageView);
            ...
            Glide.with(getActivity()).load(mImages[position])
                    .thumbnail(0.5f)
                    .crossFade()
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
