 ...
 */
public class ShowroomPendingListFragment extends Fragment {
    ...
    public ShowroomPendingListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_showroom_pending_list, container, false);
    }
    ...
    private void loadListUsedCar() {
        ...
        new FeedAsynTask().execute("http://www.teamusedcar.com/webservices/ws_used_car.asmx/ListShowRoomCarByOwner", "29", "2");
    }
